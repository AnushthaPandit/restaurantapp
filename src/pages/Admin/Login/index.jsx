...
const Login = () => {
    ...
    const handleSubmit = (e) =>{
        e.preventDefault();
        if (formState.email === "admin@mail.com" && formState.password === "admin") {
    ...
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div class="cursor-pointer flex items-center">
                ...
                <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">City Admin</div>
            </div>
        </div>
            ...
            <div class="mt-12">
                <form onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input onChange={handleChange} value={formState.email} name='email' class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" placeholder="mike@gmail.com" required />
                    </div>
                    <div class="mt-8">
                        ...
                        <input onChange={handleChange} value={formState.password} name='password' class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Enter your password" required />
                    </div>
                    <div class="mt-10">
